        ...
        <div className="flex">
            ...
            <div className="sec-center">
                ...
                <div className="section-dropdown1"> 
                    <a href="#">Bài 3.1 <i className="uil uil-arrow-right" /></a>
                    <a href="#">Bài 3.2 <i className="uil uil-arrow-right" /></a>
                    <a href="#">Bài 3.3 <i className="uil uil-arrow-right" /></a>
                    <a href="#">Bài 3.4 <i className="uil uil-arrow-right" /></a>
                </div>
            </div>
